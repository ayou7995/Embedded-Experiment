...
String motion_state = "";
String color = "f";
int  walkstraight[5] = {0,0,0,0,0};
char walkturn[6] =  {'f','f','f','f','f','\0'};
int walkcount = 0;
int intersection = 0;
int pre_lspeed = 1573, pre_rspeed = 1475;
int max_lspeed = 1579, max_rspeed = 1471;
int ori_lspeed = 1570, ori_rspeed = 1478;
int toggle = 0;
int dis = 3000;
...
void carStop(){ setServo(1535, 1520); }
...
void setup()
{
  ...
  //serial_connection.println('r'); //ble ready
